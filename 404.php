	...
	<section class="static-page-content static-page-404">
		<div class="static-page-container">
			...
			<div class="err-404-msg">
				...
				<p><?php _e('The reasons that could cause the error: incorrectly typed address, the page was never
					on this site or this page was, but can not be accessed anymore. If you reached this
					page through a link from our website, please report this at: ');
