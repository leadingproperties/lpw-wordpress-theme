<?php global $pos, $lp_settings;
	$link = '';
	$format = '<ul class="tooltip-sharing tooltip-sharing-top" data-toggle="tooltip" title="' . __('search_panel:share', 'leadingprops') . '">%1$s%2$s%3$s%4$s%5$s</ul>';
...
<section class="favorites-bar<?php if($pos) { echo ' favorites-bar-bottom';} ?>">
	<div class="container">
		<div class="fav-link-wrap">
			...
			<button type="button" class="btn btn-green fav-copy"><?php _e('search_panel:copy', 'leadingprops'); ?></button>
		</div>
